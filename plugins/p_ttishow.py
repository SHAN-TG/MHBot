...
# @Client.on_message(filters.command('invites') & filters.user(ADMINS))
...
@Client.on_message(filters.command('userss') & filters.user(ADMINS))
...
@Client.on_message(filters.command('chatss') & filters.user(ADMINS))
